// Dafny program sumarray.dfy compiled into C#
...
// Command Line Options: c:\Users\Gelo\Desktop\IIT\CS-536\HW 5\sumarray.dfy /verifyAllModules /compile:1 /spillTargetCode:1 /out:bin\sumarray
// sumarray.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger sumArray(Dafny.ISequence<BigInteger> a)
    {
      BigInteger s = BigInteger.Zero;
      BigInteger _33_i;
      _33_i = BigInteger.Zero;
      BigInteger _34_sum;
      _34_sum = BigInteger.Zero;
      while ((_33_i) < (new BigInteger((a).Count))) {
        _34_sum = (_34_sum) + ((a).Select(_33_i));
