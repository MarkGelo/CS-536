// Dafny program posneg.dfy compiled into C#
...
// Command Line Options: c:\Users\Gelo\Desktop\IIT\CS-536\HW 5\posneg.dfy /verifyAllModules /compile:1 /spillTargetCode:1 /out:bin\posneg
// posneg.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static bool eqPosNeg(Dafny.ISequence<BigInteger> a)
    {
      bool e = false;
      BigInteger _52_i;
      _52_i = BigInteger.Zero;
      BigInteger _53_npos;
      _53_npos = BigInteger.Zero;
      BigInteger _54_nneg;
      _54_nneg = BigInteger.Zero;
      while ((_52_i) < (new BigInteger((a).Count))) {
        if (((a).Select(_52_i)).Sign == 1) {
          _53_npos = (_53_npos) + (BigInteger.One);
        }
        if (((a).Select(_52_i)).Sign == -1) {
          _54_nneg = (_54_nneg) + (BigInteger.One);
        }
